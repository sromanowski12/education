...
<head>
    ...
    <script type="text/javascript">
       ...
       function displayMembers() {
           var body = document.getElementById("bodycontent");
           body.innerHTML = "<center><h2>Informatics Club Members</h2></center>";
           body.innerHTML = body.innerHTML + "<table border=1><tr><td colspan=3><center><b>Informatics Club</b></center></td></tr>" +
                "<tr><td><b>Name:</b></td>" +
                "<td><b>Email:</b></td><td><b>Interests:</b></td></tr>" +
                "<td>Seth Romanowski</td>" + 
                "<td>sromanow@iu.edu</td>" +
                "<td><li>Pizza Party</li>" +
                "<li>Visitor Employer Sites</li>" +
                "<li>Participating in Programming Competitions</li></td></tr>" +
                "<tr><td>Inyerman Fonseca</td>" + 
                "<td>inyermanfonseca@gmail.com</td>" +
                "<td><li>Pizza Party</li>" +
                "<li>Participating in Programming Competitions</li></td></tr>" +
                "<tr><td>Spencer Romanowski</td>" + 
                "<td>spencerromanowski@gmail.com</td>" +
                "<td><li>Pizza Party</li>" +
                "<li>Building Games</li></td></tr>" +
                "</table>";
...
<body>
    ...
    //    echo ("<p class='link' onclick='displayMembers();'><u>Members</u></p>");
        ...
        echo ("<hr><p><a href='http://localhost/assignment4.php'>Home</a></p></div>");
